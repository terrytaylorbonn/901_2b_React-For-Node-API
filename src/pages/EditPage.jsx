...
const EditPage = () => {
  ...
  const getProduct = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`https://nine01-devtamin.onrender.com/api/products/${id}`);
      setProduct({
  ...
  const updateProduct = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://nine01-devtamin.onrender.com/api/products/${id}`, product);
